...
export default function Album({ album }) {
    ...
    return (
        <div className="group relative w-full drop-shadow-md sm:w-58 h-52 lg:w-72 lg:h-72 xl:w-80 rounded-t-md border border-gray-500 border-b-4 border-b-gray-600">
